...
const StructuredData = () => {
	const personData = {
		...
		'description':
			'Full-Stack Software Engineer based in Zurich, Switzerland. 10+ years building enterprise solutions for Audi, Infineon, UBS, and PEAX using Java, Kotlin, Spring Boot, React, and TypeScript.',
