...
- **Display** (200, clamp(2rem, 1rem + 2.5vw, 3rem), line-height 1.05, tracking -0.025em): The hero name. Fluid scaling from mobile to desktop. Ultralight at large scale; the weight thinness is the personality.
