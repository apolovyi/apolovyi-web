...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Aktualisiert Jan 2026}\hspace{\widthof{Aktualisiert Jan 2026}}
    }}}%
  }%
}%
...
\textbf{PEAX AG}, Senior Backend-Entwickler  
\begin{highlights}  
    \item Entwicklung von digitalen Briefkasten- und Dokumentenmanagement-Lösungen für Schweizer Unternehmen.
    \item Erstellung skalierbarer Backend-Services mit Java und Spring Boot für sichere Dokumentenverarbeitung.
    \item Vorantreiben der KI-Roadmap; Einsatz von Multi-Agent LLM-Orchestrierung für Architekturanalyse über 41 Microservices.
    \item Implementierung Angular-basierter Frontend-Komponenten für intuitive Benutzererfahrungen.
\end{highlights}  
\end{twocolentry}
...
\textbf{UBS + Flowable}, Softwareentwickler  
\begin{highlights}  
 ...
 \vspace{0.6 cm}
    ...
    \begin{samepage}
        ...
        \begin{twocolentry}{
            ...
            Flowable Developer Zertifizierung
        \end{twocolentry}
    \end{samepage}
