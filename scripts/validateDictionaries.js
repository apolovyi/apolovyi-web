...
const heroSectionSchema = z.object({
  name: z.string(), greeting: z.string(), tagline: z.string(), resumeHref: z.string(),
  paragraphs: z.array(z.string()), highlightedTerms: z.array(z.string()), cta: z.string(),
})
...
const projectSchema = z.object({
  category: z.string(), company: z.string(), description: z.string(), role: z.string(), image: z.string(), link: z.string(),
  placeholder: z.string().optional(), technologies: z.array(z.string()),
})
const projectsSectionSchema = z.object({ title: z.string(), projects: z.array(projectSchema) })
const contactSectionSchema = z.object({
  title: z.string(), subtitle: z.string(), content: z.string(),
  formLabels: z.object({ name: z.string(), email: z.string(), message: z.string() }),
  sendButton: z.string(), sending: z.string(), successMessage: z.string(), errorMessage: z.string(),
})
